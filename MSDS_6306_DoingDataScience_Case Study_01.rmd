...
The purpose of this documentaton is to provide analysis answers to questions asked by you (the client) related to several different Beers and the Breweries that produce them. The Beers dataset contains a list of 2410 US craft beers and the Breweries dataset contains 558 US breweries. The datasets descriptions are as follows:
